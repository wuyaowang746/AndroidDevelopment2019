...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        MultipartBody.Part videoBody=getMultipartFromUri("video",mSelectedVideo);
        MultipartBody.Part imageBody=getMultipartFromUri("cover_image",mSelectedImage);
        ...
        Call<PostVideoResponse>upLoadCall=service.createVideo("1120161991","wx",imageBody,videoBody);
    ...
    public void fetchFeed(View view) {
        ...
        Retrofit retrofit= RetrofitManager.get("http://test.androidcamp.bytedance.com");
        IMiniDouyinService service=retrofit.create(IMiniDouyinService.class);
        Call<FeedResponse>catCall=service.fechout();
        catCall.enqueue(new Callback<FeedResponse>() {
            @Override
